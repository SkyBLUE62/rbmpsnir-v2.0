  ...
  return (
    <>
      ...
      <main className="h-[90vh] w-full relative max-w-9xl mx-auto">
        <span className="absolute  z-40 top-1/4 left-[15%] md:text-7xl text-4xl font-monument font-bold text-primary">
          The
        </span>
        <h1 className="absolute  z-40 h-auto w-full top-[35%] flex items-center justify-center  left-0  md:text-11xl text-5xl font-monument font-bold  ">
        ...
        <h2 className="absolute z-40 md:top-2/3 top-1/2 left-[60%] md:text-7xl text-4xl text-secondary font-monument font-bold">
          V2.0
        </h2>

        <p className="md:w-1/4 w-2/4 opacity-60 h-auto text-lg text-primary font-montserrat z-40 absolute md:bottom-36 bottom-5 left-2 md:left-0">
