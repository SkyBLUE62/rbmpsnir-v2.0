...
export const FiltersHome = () => {
  ...
  return (
    <div className="relative md:h-1/2-screen md:w-[4%] h-12 w-full bg-gray-300 shadow-2xl rounded-full flex md:flex-col flex-row  items-center justify-around">
      <label className="relative inline-flex items-center cursor-pointer md:rotate-90">
        <input
          type="checkbox"
