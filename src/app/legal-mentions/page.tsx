...
const page = async () => {
  return (
    <div className="h-auto bg-primary text-primary font-montserrat w-full xl:px-96 px-8 py-8 text-justify">
      <h2>Définitions</h2>
      <p>
        ...
        <Link className="text-blue-300" href="https://rbmp-snir.com">
          https://rbmp-snir.com
        </Link>{" "}
      ...
      <p>
        <strong>Propriétaire</strong> : AE ThomasWebDev – 68 rue henri lebleu
        Fleurbaix 62840 Fleurbaix
        <br />
        <strong>Responsable publication</strong> : Thomas Alexandre –
        pro.thomas.alexandre@gmail.com
        <br />
        Le responsable publication est une personne physique ou une personne
        morale.
        <br />
        <strong>Webmaster</strong> : Thomas Alexandre –
        pro.thomas.alexandre@gmail.com
        <br />
        <strong>Hébergeur</strong> : amen – 12-14 Rond Point des Champs Elysées
        75008 Paris 0 811 88 77 66
        <br />
        <strong>Délégué à la protection des données</strong> : Thomas Alexandre
        – pro.thomas.alexandre@gmail.com
        <br />
      </p>
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : ThomasWebDev.{" "}
        <Link className="text-blue-300" href="https://rbmp-snir.com">
          https://rbmp-snir.com
        </Link>
        est représenté par Thomas Alexandre, son représentant légal
      </p>
      <p>
      ...
      ThomasWebDev – DPO, Thomas Alexandre <br />
      68 rue henri lebleu Fleurbaix 62840 Fleurbaix.
      <p>
